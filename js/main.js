(() => {
  ...
  const sceneInfo = [
    ...
    },
    {
      ...
      objs: {
        ...
        imagesPath: ['./assets/images/blend-image-1.jpg', './assets/images/blend-image-2.jpg'],
        images: [],
      },
  ...
  function setCanvasImages() {
    ...
    for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
      imgElem2 = new Image();
      imgElem2.src = `./assets/002/IMG_${7027 + i}.JPG`;
